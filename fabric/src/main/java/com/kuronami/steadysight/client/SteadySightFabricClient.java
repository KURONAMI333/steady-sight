 ...
 * {@code GuiMixin} (NeoForge's HUD-layer slot has no Fabric API equivalent on
 * 1.21.1 — see that class), and the step-camera offset is applied from the
...
public final class SteadySightFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // Fabric 1.21.1 has no respawn/dimension-change equivalent of
        // NeoForge's ClientPlayerNetworkEvent.Clone; that gap is declared in
